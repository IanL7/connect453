...
#define CY_BLE_ATT_UUID_128_COUNT                   (0x04u)
 ...
 */
#define CY_BLE_P2MOVEVAL_SERVICE_INDEX   (0x00u) /* Index of P2MOVEVAL service in the cy_ble_customSServ array */
#define CY_BLE_P2MOVEVAL_USR_P2MOVE_VAL_CHAR_INDEX   (0x00u) /* Index of USR_P2MOVE_VAL characteristic */
#define CY_BLE_P2MOVEVAL_USR_P2MOVE_VAL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_BOARD_SERVICE_INDEX   (0x01u) /* Index of BOARD service in the cy_ble_customSServ array */
#define CY_BLE_BOARD_USR_BRD_CHAR_INDEX   (0x00u) /* Index of USR_BRD characteristic */
#define CY_BLE_BOARD_USR_BRD_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_P2MOVEVAL_SERVICE_HANDLE   (0x000Du) /* Handle of P2MOVEVAL service */
#define CY_BLE_P2MOVEVAL_USR_P2MOVE_VAL_DECL_HANDLE   (0x000Eu) /* Handle of USR_P2MOVE_VAL characteristic declaration */
#define CY_BLE_P2MOVEVAL_USR_P2MOVE_VAL_CHAR_HANDLE   (0x000Fu) /* Handle of USR_P2MOVE_VAL characteristic */
#define CY_BLE_P2MOVEVAL_USR_P2MOVE_VAL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_BOARD_SERVICE_HANDLE   (0x0011u) /* Handle of BOARD service */
#define CY_BLE_BOARD_USR_BRD_DECL_HANDLE   (0x0012u) /* Handle of USR_BRD characteristic declaration */
#define CY_BLE_BOARD_USR_BRD_CHAR_HANDLE   (0x0013u) /* Handle of USR_BRD characteristic */
#define CY_BLE_BOARD_USR_BRD_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */
