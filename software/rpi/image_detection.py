...
def checkValidPiece():
    ...
    columnZero = [colorArray[0], colorArray[7], colorArray[14], colorArray[21], colorArray[28], colorArray[35]]
    columnOne = [colorArray[1], colorArray[8], colorArray[15], colorArray[22], colorArray[29], colorArray[36]]
    columnTwo = [colorArray[2], colorArray[9], colorArray[16], colorArray[23], colorArray[30], colorArray[37]]
    columnThree = [colorArray[3], colorArray[10], colorArray[17], colorArray[24], colorArray[31], colorArray[38]]
    columnFour = [colorArray[4], colorArray[11], colorArray[18], colorArray[25], colorArray[32], colorArray[39]]
    columnFive = [colorArray[5], colorArray[12], colorArray[19], colorArray[26], colorArray[33], colorArray[40]]
    columnSix = [colorArray[6], colorArray[13], colorArray[20], colorArray[27], colorArray[34], colorArray[41]]

    moveDown(columnOne)
    moveDown(columnTwo)
    moveDown(columnThree)
    moveDown(columnFour)
    moveDown(columnFive)
    moveDown(columnSix)
...
def moveDown(column):
    ...
    for i in range(1,5):
        if (column[i] != 0) & (column[i-1]==0):
            column[lastPieceIndex+1] = column[i]
            column[i] = 0
        if column[i] != 0:
            lastPieceIndex = i
